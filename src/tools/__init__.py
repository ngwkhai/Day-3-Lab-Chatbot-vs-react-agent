...
# TV-show information tools (TVmaze, public API).
TVMAZE_TOOLS = [
    SHOW_INFO_TOOL,
    SHOW_RATING_TOOL,
    EPISODE_STATS_TOOL,
...
# Cinema booking is the primary domain, so its tools come first.
TOOLS = BOOKING_TOOLS + TVMAZE_TOOLS

__all__ = ["TOOLS", "BOOKING_TOOLS", "TVMAZE_TOOLS"]
